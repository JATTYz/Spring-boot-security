...
import static com.jaturon.security.security.ApplicationUserRole.*;
...
public class ApplicationSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
//                .csrf().csrfTokenRepository(CookieCsrfTokenRepository.withHttpOnlyFalse()) //for real project
//                .and()
                .csrf().disable()
                .authorizeRequests()
...
//                .httpBasic(); //this is mechanism to authenticate
    }
